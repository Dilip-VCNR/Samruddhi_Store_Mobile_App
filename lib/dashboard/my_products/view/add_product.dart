    ...
    return Consumer(
      builder: (BuildContext context, ProductsProvider productsProvider,
        ...
        return Scaffold(
          ...
          body: productsProvider.subCategoriesList!.result!=null?SingleChildScrollView(
                  ...
                  child: Stack(
                    children: [
                      CircleAvatar(
                        ...
                        backgroundImage: productsProvider.selectedImage != null
                      ...
                      Positioned(
                          ...
                          child: CircleAvatar(
                              ...
                              child: IconButton(
                                  onPressed: productsProvider.getImageFromGallery,
                                  icon: const Icon(
                ...
                Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      TextFormField(
                        textInputAction: TextInputAction.next,
                        controller: productsProvider.productNameController,
                        validator: (value) {
                          if (value!.isEmpty) {
                      ...
                      TextFormField(
                        textInputAction: TextInputAction.next,
                        controller: productsProvider.productQuantityController,
                        validator: (value) {
                          if (value!.isEmpty) {
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: ListView.builder(
                                            shrinkWrap: true,
                                            itemCount: productsProvider.categoriesList!.result!.length,
                                              ...
                                              return InkWell(
                                                onTap: () {
                                                  productsProvider
                                                      ...
                                                      .text = productsProvider.categoriesList!.result![index].productCategoryName!;
                                                  Navigator.pop(context);
                                                },
                                                child: Column(
                                                  mainAxisAlignment:
                                                  ...
                                                  children: [
                                                    Padding(
                                                      padding: const EdgeInsets
                                                          ...
                                                          vertical: 10),
                                                      child: Text(
                                                        productsProvider.categoriesList!.result![index].productCategoryName!,
                      ...
                      GestureDetector(
                        ...
                        child: TextFormField(
                          enabled: false,
                          controller: productsProvider.productUomController,
                          validator: (value) {
                            if (value!.isEmpty) {
                      ...
                      GestureDetector(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      Expanded(
                                        child: ListView.builder(
                                            shrinkWrap: true,
                                            itemCount: productsProvider.subCategoriesList!.result!.length,
                                            itemBuilder: (BuildContext context,
                                                int index) {
                                              return InkWell(
                                                onTap: () {
                                                  productsProvider
                                                      ...
                                                      .text = productsProvider.subCategoriesList!.result![index].productSubCategoryName!;
                                                  Navigator.pop(context);
                                                },
                                                child: Column(
                                                  mainAxisAlignment:
                                                  ...
                                                  children: [
                                                    Padding(
                                                      padding: const EdgeInsets
                                                          ...
                                                          vertical: 10),
                                                      child: Text(
                                                        productsProvider.subCategoriesList!.result![index].productSubCategoryName!,
                                                        style: const TextStyle(
                                                            fontSize: 18),
                                                      ),
                                                    ),
                        ...
                        child: TextFormField(
                          enabled: false,
                          controller: productsProvider.productSubCategoryController,
                          validator: (value) {
                            if (value!.isEmpty) {
                      ...
                      TextFormField(
                        textInputAction: TextInputAction.next,
                        controller:
                            productsProvider.productSellingPriceController,
                        validator: (value) {
                          if (value!.isEmpty) {
                      ...
                      TextFormField(
                        textInputAction: TextInputAction.next,
                        controller: productsProvider.productDiscountController,
                        validator: (value) {
                          if (value!.isEmpty) {
                      ...
                      TextFormField(
                        textInputAction: TextInputAction.next,
                        controller: productsProvider.productOfferController,
                        validator: (value) {
                          if (value!.isEmpty) {
                      ...
                      TextFormField(
                        textInputAction: TextInputAction.next,
                        controller: productsProvider.productMinQtyController,
                        validator: (value) {
                          if (value!.isEmpty) {
                      ...
                      TextFormField(
                        textInputAction: TextInputAction.next,
                        controller:
                            productsProvider.productManufacturerController,
                        validator: (value) {
                          if (value!.isEmpty) {
                      ...
                      TextFormField(
                        textInputAction: TextInputAction.next,
                        controller: productsProvider.productModelController,
                        validator: (value) {
                          if (value!.isEmpty) {
                      ...
                      GestureDetector(
                        ...
                        child: TextFormField(
                          enabled: false,
                          controller: productsProvider.productColorController,
                          validator: (value) {
                            if (value!.isEmpty) {
                      ...
                      GestureDetector(
                        ...
                        child: TextFormField(
                          enabled: false,
                          controller: productsProvider.productQualityController,
                          validator: (value) {
                            if (value!.isEmpty) {
                      ...
                      GestureDetector(
                        ...
                        child: TextFormField(
                          enabled: false,
                          controller: productsProvider.productSizeController,
                          validator: (value) {
                            if (value!.isEmpty) {
                      ...
                      InkWell(
                        onTap: () async {
                          if (productsProvider.addProductFormKey.currentState!
                              .validate()) {
